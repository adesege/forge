...
class PullRequestService(Service):
    """Forgejo pull request operations."""
    ...
    def view(self, number: int = 0, owner: str = "", repo: str = "") -> str:
    ...
    def close(self, number: int = 0, owner: str = "", repo: str = "") -> str:
    ...
    def reopen(self, number: int = 0, owner: str = "", repo: str = "") -> str:
    ...
    def diff(self, number: int = 0, owner: str = "", repo: str = "") -> str:
