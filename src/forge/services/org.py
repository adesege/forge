...
class OrgService(Service):
    """Forgejo organization operations."""
    ...
    def repos(self, org: str = "", limit: int = 30, page: int = 1) -> str:
    ...
    def members(self, org: str = "", limit: int = 30, page: int = 1) -> str:
